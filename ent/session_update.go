...
func (_u *SessionUpdate) SetDeviceID(id string) *SessionUpdate {
...
func (_u *SessionUpdate) check() error {
	...
	if _u.mutation.DeviceCleared() && len(_u.mutation.DeviceIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Session.device"`)
	}
	return nil
}
...
// SetDeviceID sets the "device" edge to the Device entity by ID.
func (_u *SessionUpdateOne) SetDeviceID(id string) *SessionUpdateOne {
	_u.mutation.SetDeviceID(id)
	return _u
}
