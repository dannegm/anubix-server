...
func (_c *AuditLogCreate) SetDeviceID(id string) *AuditLogCreate {
...
func (_c *AuditLogCreate) SetNillableDeviceID(id *string) *AuditLogCreate {
	if id != nil {
...
func (_c *AuditLogCreate) SetEntry(v *Entry) *AuditLogCreate {
...
func (_c *AuditLogCreate) createSpec() (*AuditLog, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.DeviceIDs(); len(nodes) > 0 {
		...
		_node.device_audit_logs = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := _c.mutation.EntryIDs(); len(nodes) > 0 {
		...
		_node.entry_audit_logs = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
