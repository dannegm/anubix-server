...
func (_u *AuditLogUpdate) SetDeviceID(id string) *AuditLogUpdate {
...
func (_u *AuditLogUpdate) SetNillableDeviceID(id *string) *AuditLogUpdate {
	if id != nil {
...
func (_u *AuditLogUpdate) SetDevice(v *Device) *AuditLogUpdate {
	return _u.SetDeviceID(v.ID)
}

// SetEntryID sets the "entry" edge to the Entry entity by ID.
func (_u *AuditLogUpdate) SetEntryID(id string) *AuditLogUpdate {
	_u.mutation.SetEntryID(id)
	return _u
}

// SetNillableEntryID sets the "entry" edge to the Entry entity by ID if the given value is not nil.
func (_u *AuditLogUpdate) SetNillableEntryID(id *string) *AuditLogUpdate {
	if id != nil {
		_u = _u.SetEntryID(*id)
	}
	return _u
...
func (_u *AuditLogUpdate) SetEntry(v *Entry) *AuditLogUpdate {
...
func (_u *AuditLogUpdate) ClearDevice() *AuditLogUpdate {
	_u.mutation.ClearDevice()
	return _u
}

// ClearEntry clears the "entry" edge to the Entry entity.
func (_u *AuditLogUpdate) ClearEntry() *AuditLogUpdate {
...
func (_u *AuditLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.DeviceCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   auditlog.DeviceTable,
			Columns: []string{auditlog.DeviceColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.EntryCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   auditlog.EntryTable,
			Columns: []string{auditlog.EntryColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetDeviceID sets the "device" edge to the Device entity by ID.
func (_u *AuditLogUpdateOne) SetDeviceID(id string) *AuditLogUpdateOne {
	_u.mutation.SetDeviceID(id)
	return _u
}

// SetNillableDeviceID sets the "device" edge to the Device entity by ID if the given value is not nil.
func (_u *AuditLogUpdateOne) SetNillableDeviceID(id *string) *AuditLogUpdateOne {
	if id != nil {
		_u = _u.SetDeviceID(*id)
	}
	return _u
...
// SetDevice sets the "device" edge to the Device entity.
func (_u *AuditLogUpdateOne) SetDevice(v *Device) *AuditLogUpdateOne {
	return _u.SetDeviceID(v.ID)
}

// SetEntryID sets the "entry" edge to the Entry entity by ID.
func (_u *AuditLogUpdateOne) SetEntryID(id string) *AuditLogUpdateOne {
	_u.mutation.SetEntryID(id)
	return _u
}

// SetNillableEntryID sets the "entry" edge to the Entry entity by ID if the given value is not nil.
func (_u *AuditLogUpdateOne) SetNillableEntryID(id *string) *AuditLogUpdateOne {
	if id != nil {
		_u = _u.SetEntryID(*id)
	}
	return _u
...
// SetEntry sets the "entry" edge to the Entry entity.
func (_u *AuditLogUpdateOne) SetEntry(v *Entry) *AuditLogUpdateOne {
	return _u.SetEntryID(v.ID)
}
...
// ClearDevice clears the "device" edge to the Device entity.
func (_u *AuditLogUpdateOne) ClearDevice() *AuditLogUpdateOne {
	_u.mutation.ClearDevice()
	return _u
}

// ClearEntry clears the "entry" edge to the Entry entity.
func (_u *AuditLogUpdateOne) ClearEntry() *AuditLogUpdateOne {
	_u.mutation.ClearEntry()
	return _u
}
